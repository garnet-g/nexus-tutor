...
const SEED_FILES = [
  ...
  {
    path: "supabase/migrations/20260625170000_kcse_math_f2_b2.sql",
    expectedLessonCount: 45,
  },
  {
    path: "supabase/migrations/20260625180000_kcse_math_f2_b3.sql",
    expectedLessonCount: 45,
  },
  {
    path: "supabase/migrations/20260625190000_kcse_math_f2_b4.sql",
    expectedLessonCount: 45,
  },
  {
  ...
  {
    path: "supabase/migrations/20260625220000_kcse_math_f3_b3.sql",
    expectedLessonCount: 45,
  },
  {
    path: "supabase/migrations/20260625230000_kcse_math_f4_b1.sql",
    expectedLessonCount: 45,
  },
  {
    path: "supabase/migrations/20260625240000_kcse_math_f4_b2.sql",
    expectedLessonCount: 45,
  },
] as const;
