...
JOIN public.subtopics st ON st.topic_id=t.id AND st.code='profit_loss'
WHERE c.code='KCSE' AND s.code='mathematics' AND t.code='commercial_arithmetic_i'
AND NOT EXISTS (SELECT 1 FROM public.practice_questions pq WHERE pq.topic_id=t.id AND pq.question_text='CP KES $960$, profit KES $240$. Profit percentage on CP?');
...
JOIN public.subtopics st ON st.topic_id=t.id AND st.code='linear_graphs'
WHERE c.code='KCSE' AND s.code='mathematics' AND t.code='coordinates_graphs'
AND NOT EXISTS (SELECT 1 FROM public.practice_questions pq WHERE pq.topic_id=t.id AND pq.question_text='Gradient of line through $(1, 2)$ and $(5, 10)$?');
...
JOIN public.subtopics st ON st.topic_id=t.id AND st.code='polygons'
WHERE c.code='KCSE' AND s.code='mathematics' AND t.code='angles_plane_figures'
AND NOT EXISTS (SELECT 1 FROM public.practice_questions pq WHERE pq.topic_id=t.id AND pq.question_text='Each exterior angle of a regular octagon?');
